...
function EditForm(props: EditFormType) {
    debugger
    ...
    return(
        <tr>
            ...
            <td>{<input type="text" value={contentNameState} 
                onChange={(e) => setNameState(e.currentTarget.value)} />}</td>
            ...
            <td>{<input type="text" value={contentState} 
                onChange={(e) => setState(e.currentTarget.value)} />}</td>

            <td>{props.noteLine.dates}</td>

            <td onClick={() => editNote()}> 
                <input type="image" src={getButtonIcon("edit")}/>
                <span> Send </span> 
            </td>
        </tr>
    )
